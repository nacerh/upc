...
void runAnalysis()
{
    ...
    if(local) {
        ...
        // for(Int_t i = 100; i<115; i++)
        // {
        //     if(i == 111) continue;
        //     TFile* inputfile = new TFile(Form("/home/nacer/upc/Phi0/rawdata/AliESDs_%i.root", i));
        //     if(inputfile->IsZombie() && inputfile->TestBit(TFile::kRecovered)) continue;
        //     chain->Add(Form("/home/nacer/upc/Phi0/rawdata/AliESDs_%i.root", i)); //AliESDs, AliAOD
        // //     TFile* inputfile = new TFile(Form("/home/nacer/upc/Phi0/input/15000246757019.%i/AliESDs.root", i));
        // //     if(inputfile->IsZombie() && inputfile->TestBit(TFile::kRecovered)) continue;
        // //     chain->Add(Form("/home/nacer/upc/Phi0/input/15000246757019.%i/AliESDs.root", i)); //AliESDs, AliAOD
        // }
        ...
        alienHandler->SetAliPhysicsVersion("vAN-20181028_ROOT6-1"); //vAN-20210920-1, vAN-20181028_ROOT6-1
        ...
        alienHandler->SetSplitMaxInputFileNumber(40); //200
        alienHandler->SetExecutable("TaskUpcPhi0.sh");
        // specify how many seconds your job may take
        alienHandler->SetTTL(40000); //40000 sec
        ...
        alienHandler->SetMaxMergeStages(1); //50
        ...
        if(gridTest) {
            ...
            alienHandler->SetNtestFiles(40); //4
            // and launch the analysis
            alienHandler->SetRunMode("test"); //test
